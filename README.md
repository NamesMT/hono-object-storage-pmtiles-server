...
### Info & Bench
This PMTiles server is also A LOT MORE faster, and efficient than [Martin tile server](https://github.com/maplibre/martin), though, because of the SDK to interract with S3.
